	...
	const contactCardData = [
		{
			id: 1,
			title: "Call Us",
			icon: <FiPhoneCall className='text-red-600 text-2xl xl:text-4xl' />,
			type: "tel",
		...
		},
		{
			...
			title: "Email Us",
			type: "email",
			icon: <RxEnvelopeClosed className='text-red-600 text-2xl xl:text-4xl' />,
		...
		},
		{
			...
			title: "Location",
			type: "text",
			icon: <IoLocationOutline className='text-red-600 text-2xl xl:text-4xl' />,
