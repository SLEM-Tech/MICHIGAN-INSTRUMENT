											...
											{OrderData?.map((order, i) => (
												...
												>
													...
													<td className='px-5 py-3 whitespace-nowrap text-right text-sm'>
														<Link
															href={`/order/${order.id}`}
															className='px-3 py-1 bg-[#D62E55] w-fit mx-auto text-xs flex justify-center text-white hover:bg-[#D62E55] hover:text-white transition-all font-semibold rounded-full cursor-pointer'
														>
															Details
														</Link>
													</td>
