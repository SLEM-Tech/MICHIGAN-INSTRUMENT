    ...
    <AppLayout>
      <main className="bg-white mx-auto mt-28 lg:mt-16 pb-24">
        <section className="flex w-full flex-col items-center pt-8 xl:pt-16 gap-2 sm:gap-3 px-4 sm:px-8 md:px-16 text-center">
          ...
          <div className="w-md min-w-xl flex lg:justify-center gap-2 mt-3 xl:mt-8 text-[10px] xs:text-xs sm:text-sm slg:text-base leading-[140%] bg-[#F5F5F5] p-1 rounded-md transition">
            <button
